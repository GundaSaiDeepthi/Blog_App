...
function ArticleByID() {
  ...
  useEffect(() => {
    ...
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(`https://blog-app-1-n245.onrender.com/user-api/article/${id}`, { withCredentials: true });
  ...
  const toggleArticleStatus = async () => {
    ...
    try {
      const res = await axios.patch(
        `https://blog-app-1-n245.onrender.com/author-api/articles/${id}/status`,
  ...
  const addComment = async (commentObj) => {
    ...
    let res = await axios.put("https://blog-app-1-n245.onrender.com/user-api/articles", commentObj, { withCredentials: true });
    if (res.status === 200) {
      toast.success(res.data.message);
      setArticle(res.data.payload);
    }
