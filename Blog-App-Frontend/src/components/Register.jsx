  ...
  const onUserRegister = async (newUser) => {
    ...
    try {
      if (role === "user") {
        ...
        let resObj = await axios.post("https://blog-app-1-n245.onrender.com/user-api/users", formData);
      ...
      if (role === "author") {
        ...
        //make API req to user-api
        let resObj = await axios.post("https://blog-app-1-n245.onrender.com/author-api/users", formData);
